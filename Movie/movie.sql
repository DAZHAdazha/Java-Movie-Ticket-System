...
INSERT INTO `cinema` VALUES (1,'万达影城（蜀都万达广场店）','郫都区郫筒镇望丛东路139号4F-1');
INSERT INTO `cinema` VALUES (2,'太平洋影城（时代豪廷店）','郫都区望丛中路1092号时代豪廷广场3楼、4楼');
INSERT INTO `cinema` VALUES (3,'太平洋影城（龙城国际店）','郫都区红高路88号龙城国际3楼（太平洋影院）');
INSERT INTO `cinema` VALUES (4,'横店电影城（郫县店）','郫都区郫筒镇一环路西北路188号郫县百伦广场商业楼六层');
INSERT INTO `cinema` VALUES (5,'SFC上影影城（成都龙湖IMAX店）','郫都区高新西区合作路89号龙湖时代天街16栋4F');
INSERT INTO `cinema` VALUES (6,'越界影城（郫县店）','郫都区东大街699号恒创蜀都广场4楼（时代花城旁）');
INSERT INTO `cinema` VALUES (7,'中影星美国际影城（犀浦百伦店）','郫都区犀浦镇国宁东路69号（百伦广场）5楼（近怡景城市）');
INSERT INTO `cinema` VALUES (8,'C+影城（双铁广场RealD店）','郫都区犀浦镇双铁路69号润扬双铁广场石犀里负一楼（麦当劳侧下方3号门）');
INSERT INTO `cinema` VALUES (9,'CGV影城（犀浦IMAX店）','郫都区犀浦泰山北街1号凯德乐视界4楼CGV影城');
INSERT INTO `cinema` VALUES (10,'EVO艺威影院（龙湖时代天街店）','郫都区合作路89号龙湖时代天街25幢3层01号（商场外）');
INSERT INTO `cinema` VALUES (11,'中影文星影城（郫都店）','郫都区杜鹃路46号汉正广场店1栋601');
INSERT INTO `cinema` VALUES (12,'嘉裕国际影城（郫县店）','郫都区犀浦镇校园路东段99号绵世.溪地湾四期3.4层');
INSERT INTO `cinema` VALUES (13,'团结九州星辰电影城（传媒店）','郫都区团结镇成都理工大学广播影视学院校内艺体中心一楼');
INSERT INTO `cinema` VALUES (14,'天智国际影城（红光店）','郫都区团结镇成都理工大学广播影视学院校内艺体中心一楼');
INSERT INTO `cinema` VALUES (15,'太平洋院线影城（安靖店）','郫都区安靖镇金河路173号附2号');
INSERT INTO `cinema` VALUES (16,'德源菁创影城','郫都区德源镇田坝东街45号');
INSERT INTO `cinema` VALUES (17,'星光影城（美乐广场店）','郫都区团结镇学院街18号1栋4楼2号');
INSERT INTO `cinema` VALUES (18,'水乡记忆电影院','郫都区三道堰柏条河二段193号');
...
INSERT INTO `movie` VALUES (1, '阿凡达', 'Avatar', '萨姆·沃辛顿,佐伊·索尔达娜', '詹姆斯·卡梅隆', '战斗中负伤而下身瘫痪的前海军战士杰克·萨利（萨姆·沃辛顿 饰）决定替死去的同胞哥哥到潘多拉星控操纵格蕾丝博士（西格妮·韦弗 饰）用人类基因与当地纳美部族基因结合创造出的“阿凡达“混血生物。”杰克的目的是打入纳美部落，外交说服他们自愿离开世代居住的家园，从而SecFor公司可砍伐殆尽该地区的原始森林，开采地下昂贵的“不可得”矿。在探索潘多拉星的过程中，杰克遇到了纳美部落的公主娜蒂瑞（佐伊·索尔达娜饰），向她学习了纳美人的生存技能与对待自然的态度。与此同时，SecFor公司的经理和军方代表上校迈尔斯（史蒂芬·朗 饰）逐渐丧失耐心，决定诉诸武力驱赶纳美人。', '162分钟', '动作,科幻,冒险', 9.3, 15.33, 7, '2021-03-12', '美国,英国', '../upload/movies/阿凡达.jpg', 1);
INSERT INTO `movie` VALUES (2, '五尺天涯', 'Five Feet Apart', '海莉·露·理查森,科尔·斯普罗斯,莫伊塞斯·阿里亚斯', '贾斯汀·贝尔杜尼', '少女斯黛拉在医院治疗“囊性纤维化”的过程中，遇见了患有同样病症的男孩威尔，但病患间必须遵守“六英尺安全距离”，以避免相互感染危及生命。斯黛拉的乐观感染着脆弱敏感的威尔，在甜蜜互动中两人越走越近。他们用爱缩短了一英尺的距离，谈起了一场无法触碰的恋爱，逐渐照亮了彼此的生命……', '117分钟', '剧情,爱情', 8.8, 0.529, 5, '2021-03-12', '美国', '../upload/movies/五尺天涯.jpg', 1);
INSERT INTO `movie` VALUES (3, '你好，李焕英', 'Hi, Mom', '贾玲,张小斐,沈腾', '贾玲', '2001年的某一天，刚刚考上大学的贾晓玲（贾玲 饰）经历了人生中的一次大起大落。一心想要成为母亲骄傲的她却因母亲突遭严重意外，而悲痛万分。在贾晓玲情绪崩溃的状态下，竟意外的回到了 1981 年，并与年轻的母亲李焕英（张小斐 饰）相遇，二人形影不离，宛如闺蜜。与此同时，也结识了一群天真善良的好朋友。晓玲以为来到了这片“广阔天地”，她可以凭借自己超前的思维，让母亲“大有作为”，但结果却让晓玲感到意外......', '128分钟', '喜剧,剧情', 9.5, 52.84, 5, '2021-02-12', '中国大陆', '../upload/movies/你好，李焕英.jpg', 1);
INSERT INTO `movie` VALUES (4, '猫和老鼠', 'Tom and Jerry', '科洛·格蕾斯·莫瑞兹,迈克尔·佩纳,郑肯', '蒂姆·斯托瑞', '杰瑞于“世纪婚礼”前夕搬进了纽约市最豪华的御门酒店，迫使婚礼策划人凯拉雇佣了汤姆来赶走他。然而，随之而来的猫鼠大战有可能葬送凯拉的事业，破坏世纪婚礼，甚至毁掉整个酒店。但很快，更大的问题出现了：野心勃勃的活动经理特伦斯正在密谋同时对付他们三个人。', '101分钟', '喜剧,动画,冒险', 7.9, 1.01, 4, '2021-02-26', '美国', '../upload/movies/猫和老鼠.jpg', 1);
INSERT INTO `movie` VALUES (5, '唐人街探案3', 'Last Letter', '周迅:袁之华,秦昊:尹川,杜江:周文涛', '岩井俊二', '有人慌张得见面，有人简单地告别。姐姐袁之南离世的那个清晨，只匆匆留下一封信和一张同学会邀请函。妹妹之华(周迅 饰)代替姐姐参加，却意外遇见年少时的倾慕对象尹川（秦昊 饰）。往日的记忆在苏醒，但再次相见，已物是人非', '114分钟', '爱情', 7.9, 1.0108, 5, '2019-07-20', '中国大陆、日本', '../upload/movies/唐人街探案3.jpg', 1);
INSERT INTO `movie` VALUES (6, '新神榜：哪吒重生', 'New Gods:Nezha Reborn', '杨天翔,张赫,宣晓鸣', '赵霁', '三千年前，天下动荡，人神共遇大劫，不想哪吒的一缕魂魄逃脱天罗地网，世世转世投胎，这一世与东海市酷爱机车的热血青年李云祥人神共生。然而龙族对哪吒恩怨并未善罢甘休，有着哪吒元神的李云祥，亦无法逃脱被龙族赶尽杀绝的宿命。东海危在旦夕，李云祥是否能够与哪吒元神并肩作战，成为抵抗龙族的英雄？东海市的子民能否得到拯救？', '116分钟', '动作,奇幻,动画', 8.7, 4.43, 2, '2021-02-12', '中国大陆', '../upload/movies/新神榜：哪吒重生.jpg', 0);
INSERT INTO `movie` VALUES (7, '刺杀小说家', 'A WRITER''S ODYSSEY', '雷佳音,杨幂,董子健', '路阳', '异世界皇都，天神赤发鬼残暴统治，滥杀无辜。少年空文因被赤发鬼追杀，决定奋起反击。在黑甲的指引下，踏上了凡人弑神之路。这是小说家路空文笔下的奇幻世界。没想到小说的进程，竟然影响着现实世界。这时一名男子接下了刺杀他的任务…', '130分钟', '奇幻 动作 冒险', 8.6, 10.14, 3, '2021-02-12', '中国大陆', '../upload/movies/刺杀小说家.jpg', 0);
INSERT INTO `movie` VALUES (8, '人潮汹涌', 'Endgame', '刘德华,肖央,万茜', '饶晓志', '2021年，你做好准备换个活法，牛转乾坤了吗？ 顶级杀手周全（刘德华 饰）和落寞群演陈小萌（肖央 饰）在一次意外中交换了身份。杀手在跌入谷底的过程中，重新审视了爱情和生活；群演在冒充杀手的过程中，彻底重塑了人生。两个人一起历经的荒诞，有啼笑皆非，更有热血沸腾。', '119分钟', '剧情,喜剧,爱情', 9.1, 6.96, 3, '2021-02-12', '中国大陆', '../upload/movies/人潮汹涌.jpg', 0);
INSERT INTO `movie` VALUES (9, '熊出没·狂野大陆', 'Boonie Bears:The Wild Life', '张秉君,谭笑,张伟', '丁亮', '什么才是快乐的真谛？一场起源于爱的冒险！狗熊岭附近新开业了一个神奇的“狂野大陆”，在那里，通过基因技术人可以自由变身各种动物，享受无比的自由和快乐。导游事业受挫的光头强，阴差阳错与神秘人乐天和熊二组队，参加乐园里奖金丰厚的比赛，却遭遇了队友乐天的背叛，历尽艰险终于获得冠军之际， 却意外发现狂野大陆中出现了肆意袭击他人的混合变身怪兽，同时也明白了队友乐天窃取基因手环的背后的真相。为了守护基因变身技术所承载的美好初衷，光头强与乐天冒险闯入总部，却再次发现在老板汤姆背后隐藏着真正的幕后黑手，他们是否能够获取最终的胜利？神秘人乐天背后又有着怎样的故事…', '99分钟', '喜剧,科幻,动画', 8.9, 5.82, 3, '2021-02-12', '中国大陆', '../upload/movies/熊出没·狂野大陆.jpg', 0);
INSERT INTO `movie` VALUES (10, '寻龙传说', 'Raya and The Last Dragon', '赵丽颖,凯莉·玛丽·陈,奥卡菲娜', '唐·霍尔', '很久以前，在充满奇幻色彩的龙佑之邦（Kumandra),人类和龙和谐地生活在一起。但当一股邪恶的力量袭来，龙牺牲了自己来拯救人类。500年后，同样的邪恶力量卷土重来，只有一个孤独的战士拉雅（Raya）承担重任，追踪传说中的最后一条龙，以修复这块破碎的土地，团结分裂的人民。在她的旅程中，她也会逐渐了解到拯救世界不仅仅需要一条龙，还需要信任和团队合作。', '108分钟', '动画', 9.1, 0.992, 3, '2021-03-05', '美国、澳大利亚', '../upload/movies/寻龙传说.jpg', 0);
